  ...
  <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
    <div class="wf-ull lg:w-1/2">
      ...
      <div class="flex items-center mt-6 gap-x-3">
        ...
        <a href="/" class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary-500 rounded-lg shrink-0 sm:w-auto hover:bg-secondary-600">
          Take me home
        </a>
      </div>
    </div>
