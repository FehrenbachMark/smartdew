...
<form action="/auth/auth.php" method="POST">
  <div class="mx-auto my-36 flex h-[auto] w-[350px] flex-col border-2 bg-white text-black shadow-xl">
    ...
    <div class="flex flex-col items-center">
      ...
      <input class="my-2 w-72 border p-2" name="username2" type="text" placeholder="Confirm Username" />
      <input class="my-2 w-72 border p-2" name="password" type="password" placeholder="Password" />
      <input class="my-2 w-72 border p-2" name="password2" type="password" placeholder="Confirm Password" />
      <input class="my-2 w-72 border p-2" name="device ID" type="number" placeholder="SmartDew Device ID" />
    </div>
    <div class="my-2 flex justify-center">
      <button type="submit" name="register" class="w-72 border bg-[#0DE6AC] hover:bg-[#b8f8f5] ease-in-out transition-all duration-200 p-2 font-sans">Register</button>
    </div>
